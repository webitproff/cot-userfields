...
// Глобальные переменные, доступные в page.tags
global $t, $pag;
...
// В модуле page автор страницы всегда лежит в $pag['page_ownerid']
$user_id = isset($pag['page_ownerid']) ? (int)$pag['page_ownerid'] : 0;
